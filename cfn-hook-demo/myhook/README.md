# AWSNonprofits::gmike::Tagging

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `awsnonprofits-gmike-tagging.json`
2. Implement your resource handlers in `awsnonprofits_gmike_tagging/handlers.py`
